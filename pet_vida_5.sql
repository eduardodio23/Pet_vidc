-- PET_VIDA_5: Triggers e auditoria
USE pet_vida;
...
VALUES (1, 1, NOW(), 'Teste de trigger', 120.00, 'agendada');
UPDATE consultas SET status = 'concluida' WHERE id_consulta = 3;
DELETE FROM consultas WHERE id_consulta = 90;
UPDATE pagamentos SET status = 'pago' WHERE id_pagamento = 3;
